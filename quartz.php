...
<head>
  ...
  <title>Quartz - Lancaster Stones</title>
      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-lg-start" id="change_image" data-aos="fade-right">
            <img style="min-height: 400px; width: 550px;" src="assets/img/kitchen/images/quartz/1.png" alt="design">
          </div>
            ...
            <div class="content d-flex flex-column justify-content-center">
              ...
              <div class="row">
                ...
                <div class="col-md-3 icon-box" data-aos="fade-up">
                  ...
                  <img src="assets/img/kitchen/countertops/quartz/1.jpg" onclick="display(1)" alt="image_1">
                </div>
                ...
                <div class="tab-content">
                  <div class="tab-pane active show" id="tab-1">
                    <div class="container">
                       <div class="row">
                          <div class="col-md-3">
                            <img src="assets/img/kitchen/countertops/quartz/1.jpg" alt="" onclick="display(1)" class="img-fluid">
                          </div>
                          <div class="col-md-3">
                            <img src="assets/img/kitchen/countertops/quartz/2.jpg" alt="" onclick="display(2)"  class="img-fluid">
                         </div>
                         <div class="col-md-3">
                            <img src="assets/img/kitchen/countertops/quartz/3.jpg" alt="" onclick="display(3)" class="img-fluid">
                         </div>
                         <div class="col-md-3">
                            <img src="assets/img/kitchen/countertops/quartz/4.jpg" alt="" onclick="display(4)" class="img-fluid">
                         </div>
                       </div>
                    </div>
                  </div>
