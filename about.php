...
<head>
  ...
  <title>About - Lancaster Stones</title>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-lg-start" data-aos="fade-right">
            <img style="min-height: 400px; width: 550px; border-radius: 20px;" src="assets/img/about.jpg" alt="design">
          </div>
          <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
            <div class="content d-flex flex-column justify-content-center">
              <h3 data-aos="fade-up">About Our Company</h3>
              <p data-aos="fade-up">
                Lancaster Stones began 15 years ago when its owner decided to provide his neighbors with the most luxurious of options for countertops, backsplashes and vanity tops.
              </p>
              <!-- <div class="row">
